...
// La classe book è un estensione di Publication 
...
//this fa riferimento all'oggetto che stiamo costruendo
        super(title, dop, publisher); // passa le proprietà di Publication // scrivendo questo sto dicendo che Book si deve gestire solo il parametro che non eredita da Publication, vale a dire author
        this.author = author;
